...
plot(MC_SD[,1],(MC_SD[,2]/MC_SD[,3])^2,type='o',
     ...
     #ylim=range(MC_SD[,2]/MC_SD[,3],MC_SD[,2]/MC_SD[,4],MC_SD[,2]/MC_SD[,5],MC_SD[,2]/MC_SD[,6]),
     ylim=c(0,4),
     col="black",pch=1)
lines(MC_SD[,1],(MC_SD[,2]/MC_SD[,4])^2,type='o',col="red",lwd=2,pch=2)
lines(MC_SD[,1],(MC_SD[,2]/MC_SD[,5])^2,type='o',col="purple",lwd=2,pch=3)
# lines(MC_SD[,1],MC_SD[,2]/MC_SD[,6],type='o',col="blue",pch=6)
...
#      #                 list(pt=pt,h.degree=h.degree,s_string=s_string)),
#      col="blue",pch=4)
# lines(CRATE[,1],CRATE[,3],type='o',col="black",lwd=2,pch=1)
# lines(CRATE[,1],CRATE[,4],type='o',col="red",lwd=2,pch=2)
# lines(CRATE[,1],CRATE[,5],type='o',col="purple",lwd=2,pch=3)
