...
helper<-function(results,BIAS,MC_SD,EST_SD,CRATE,sample_index)
{
  results=rbind(results,cbind(
    ...
    (MC_SD[sample_index,2]/MC_SD[sample_index,c(3,5,6,4)])^2,
    (EST_SD[sample_index,c(3,5,6,4)]/MC_SD[sample_index,c(3,5,6,4)])^2,
    CRATE[sample_index,c(3,5,6,4)]))
  return(results)
}
sample_index=c(1,6,16,17)
...
print(xtable(results_one,digits=c(0,0,rep(3,12))),include.rownames = F)
